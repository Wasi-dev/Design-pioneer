          ...
          <div class="col-lg-12 v-center">
            <div class="bread-inner">
              <div class="bread-title">
                <h2>Website Designs That Are Designed To Convert</h2>
                  <p class="mt20 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
When people land on your website, they only have a few seconds to decide whether they will stay or leave. They won't bother exploring your business further if your website doesn't look professional. 
                  </p>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="image-block upset">
            <img src="assest/images/web-dev.png" alt="case study" class="img-fluid no-shadow">
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="image-block upset bg-shape wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
            <img src="assest/images/mob-app.png" alt="image" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-8 block-1">
          ...
          <ul class="h-scroll tech-icons">
            ...
            <!-- <li><a href="javascript:;"><img src="assest/images/icons/stack-icon8.png" alt="icon"></a></li> -->
          </ul>
        </div>
      </div>
    </div>
                                                    ...
                                                    <div class="niwaxpricingbox shadow">
                                                        ...
                                                        <div class="priceodernow">
                                                            <div class="priceoderbtn"><a href="#offcanvasExample" data-bs-toggle="offcanvas"
                                                                    class="niwax-btn3">Order Now</a></div>
                                            ...
                                            <div class="screen-splits">
                                                <div class="nxpb-2">
                                                    <div class="niwaxpricingbox shadow reco selected-itm">
                                                        ...
                                                        <div class="priceodernow">
                                                            <div class="priceoderbtn"><a href="#offcanvasExample" data-bs-toggle="offcanvas"
                                                                    class="niwax-btn2">Order Now</a></div>
                                                            <div class="priceaskwithus">
                                                                <a href="javascript:$zopim.livechat.window.show();"
               ...
               <div class="row">
                  <div class="col-lg-12 col-md-12">
                     <div class="combo-pricing-table best-plan">
                        ...
                        <div class="priceodernow">
                              <a href="#offcanvasExample" data-bs-toggle="offcanvas" class="btn-main bg-btn lnk wow fadeIn" data-wow-delay="0.8s">Let's Order Now <i class="fas fa-chevron-right fa-ani"></i><span class="circle"></span></a>
                           <div class="priceaskwithus">
     ...
     <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="common-heading">
          ...
          <h2 class="mb30">With Us, You Have Complete Freedom to Create a Business Website from  <span>Scratch..</span></h2>
        </div>
      </div>
    </div>
    <div class="row">
               ...
               <div class="whychooseniwax v-center">
                  ...
                  <div class="common-heading ptag new" >
                     ...
                     <div class="pairofbtn mt90 new wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-name: fadeInUp;">
                        <a href="#offcanvasExample" data-bs-toggle="offcanvas" class="niwax-btn3">Get In Touch With Us</a>
                 ...
                 <div class="slide swiper-wrapper">
                  <!-- <ul> -->
                     <!-- <li class="wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;"> -->
                        <div class="swiper-slide"><img src="assest/images/client/new-cc-01.svg" alt="text" class="img-fluid">
                        </div>
                     <!-- </li> -->
                     <!-- <li class="wow fadeIn" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;"> -->
                        <div class="swiper-slide"><img src="assest/images/client/new-cc-02.svg" alt="text" class="img-fluid">
                        </div>
                     <!-- </li> -->
                     <!-- <li class="wow fadeIn" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeIn;"> -->
                        <div class="swiper-slide"><img src="assest/images/client/new-cc-03.svg" alt="text" class="img-fluid">
                        </div>
                     <!-- </li> -->
                     <!-- <li class="wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;"> -->
                        <div class="swiper-slide"><img src="assest/images/client/new-cc-04.svg" alt="text" class="img-fluid">
                        </div>
                     <!-- </li> -->
                     <!-- <li class="wow fadeIn" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeIn;"> -->
                        <div class="swiper-slide"><img src="assest/images/client/new-cc-05.svg" alt="text" class="img-fluid">
                        </div>
                     <!-- </li> -->
                     <!-- <li class="wow fadeIn" data-wow-delay="1.2s" style="visibility: visible; animation-delay: 1.2s; animation-name: fadeIn;"> -->
                        <div class="swiper-slide"><img src="assest/images/client/new-cc-06.svg" alt="text" class="img-fluid">
                        </div>
                     <!-- </li> -->
                  <!-- </ul> -->
               </div>
 ...
 <section class="enquire-form pad-tb">
	...
	<div class="form-block">
		...
		<div class="fieldsets row">
			<div class="col-md-6"><input type="text" placeholder="Full Name" name="sender3" required=""></div>
			<div class="col-md-6"><input type="email" placeholder="Email Address" name="senderEmail3" required=""></div>
		</div>
		<div class="fieldsets row">
			<div class="col-md-12"><input type="tel" placeholder="Contact Number" name="senderNumber3" required=""></div>
			<!--<div class="col-md-6"><input type="text" placeholder="Subject" name="subject"></div>-->
		</div>
		<div class="fieldsets"><textarea placeholder="Message" name="message3" required=""></textarea></div>
		...
		<div class="fieldsets mt20">
		    ...
		    <input type="submit" name="submit3" class="lnk btn-main bg-btn sum-btn" value="Submit">
	    </div>
