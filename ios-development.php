      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="image-block upset">
            <img src="assest/images/img-sao-ad-3.webp" alt="case study" class="img-fluid no-shadow">
          </div>
        </div>
        <div class="col-lg-6 block-1 v-center">
          <div class="common-heading inner-heading text-l pl25">
            ...
            <p>  
            Our team has worked on countless projects and understands exactly what it takes to deliver superior results. From initial concept to final delivery, we'll be by your side every step of the way. 
            The apps that we design and develop for you won't only look incredible; they will also function perfectly. We'll go above and beyond to exceed your expectations. 
            Our talented team members will ensure that your app exceeds industry standards and provides your users with a unique, intuitive and immersive experience.
            </p>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="image-block upset bg-shape wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
            <img src="assest/images/iOS.webp" alt="image" class="img-fluid">
          </div>
        </div>
     ...
     <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="common-heading">
          ...
          <h2 class="mb30">With Us, You Have Complete Freedom to Create an iOS App from <span> Scratch.</span></h2>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-4">
        ...
        <div class="niwax-list">
          <ul class="list-ul ul-circle">
            ...
            <li>  Hybrid iOS Apps</li>
           <li>   Native Android Applications</li>
           <li>   Cross-Platform Mobile Development</li>
           <li>   Ionic Framework Development</li>
            <li>  Swift, Objective C, Java, Python & HTML5</li>
