          ...
          <div class="col-lg-12 v-center">
            <div class="bread-inner">
              <div class="bread-title">
                <h2>WordPress Websites That Turn Visitors into Customers</h2>
                  <p class="mt20 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                        As a leading digital solutions provider, we understand how important it is for people to find your website. If your site doesn't have a professional look, it won't receive many visitors. Many potential customers will think you don't offer quality services and may choose to go elsewhere instead.
                  </p>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="image-block upset">
            <img src="assest/images/service/wordpress/wp-01.png" alt="case study" class="img-fluid no-shadow">
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="image-block upset bg-shape wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
            <img src="assest/images/service/wordpress/wp-02.png" alt="image" class="img-fluid">
          </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="tabs-layout">
            ...
            <div class="tab-content" id="myTabContent1">
                <div class="tab-pane fade active show" id="Wordpress-ada" role="tabpanel" aria-labelledby="Wordpress-ada-tab">
                    <div class="container">
                        <div class="row justify-content-center">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="common-heading">
          <span>What Types of Websites?</span>
          <h2 class="mb0">All-Encompassing Website Solutions Provider</h2>
        </div>
      </div>              
    </div>
    <div class="row upset">
      <div class="col-lg-4 col-md-6 mt30 wow fadeIn" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
        <div class="service-card-app hoshd">
          <h4><a href="front-end-development.html">Front-End Development</a> </h4>
          ...
          <p class="mt20">Services include customized templates, building user interfaces, and creating responsive websites.</p>
          <a href="front-end-development.html" class="mt20 link-prbs">Read More <i class="fas fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mt30 wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
        <div class="service-card-app hoshd">
          <h4><a href="back-end-development.html"> Back-End Development</a></h4>
          <ul class="-service-list mt10">
          ...
          <p class="mt20"> We can build robust backend applications and can integrate third-party APIs.</p>
          <a href="back-end-development.html" class="mt20 link-prbs">Read More <i class="fas fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mt30 wow fadeIn" data-wow-delay="0.8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
        <div class="service-card-app hoshd">
          ...
          <p class="mt20">We have a team of talented full-stack developers who can handle all aspects of web development.</p>
     ...
     <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="common-heading">
          ...
          <h2 class="mb30">With Us, You Have Complete Freedom to Create an Excellent Website from  <span> Scratch.</span></h2>
        </div>
      </div>
    </div>
    <div class="row">
