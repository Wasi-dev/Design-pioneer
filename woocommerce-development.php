      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="image-block upset">
            <img src="assest/images/WooCommerce-Development.webp" alt="case study" class="img-fluid no-shadow">
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="image-block upset bg-shape wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
            <img src="assest/images/woocommerce-development (1).webp" alt="image" class="img-fluid">
          </div>
        </div>
                                                ...
                                                <div class="nxpb-2">
                                                    <div class="niwaxpricingbox shadow reco selected-itm">
                                                        <div class="pricingheader"
                                                            data-background="assest/images/icons/new/3643948.svg"
                                                            style="background-image: url(&quot;assest/images/icons/plan-1.svg&quot;);">
                                                            <h2>Professional <br> eCom Package</h2>
                                                            <p>Great For Small Business</p>
                                                        </div>
                                                        <div class="pricingrate">
                                                            <div class="pricevalue">
   ...
   <div class="gradient-bg">
      ...
      <div class="container bg-transparent-glass pl--70 pr--70 pt70 pb70">
         ...
         <div class="row align-items__center mb30">
            ...
            <!--   <ul class="nav nav-tabs" id="myTab1" role="tablist">-->
            <!--      <li class="nav-item ">-->
            <!--         <a class="nav-link active combo-nav" id="home-tab" data-bs-toggle="tab" href="#websites" role="tab" aria-controls="websites" aria-selected="true">Startup</a>-->
            <!--      </li>-->
            <!--      <li class="nav-item ">-->
            <!--         <a class="nav-link combo-nav" id="profile-tab" data-bs-toggle="tab" href="#Ecommerce" role="tab" aria-controls="Ecommerce" aria-selected="false">Ecommerce</a>-->
            <!--      </li>-->
            <!--      <li class="nav-item">-->
            <!--         <a class="nav-link combo-nav" id="contact-tab" data-bs-toggle="tab" href="#Marketing" role="tab" aria-controls="Marketing" aria-selected="false">Marketing</a>-->
            <!--      </li>-->
        ...
        <div class="row upset">
          <div class="col-lg-4 col-md-6 mt30 wow fadeIn" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
            <div class="service-card-app hoshd">
              <h4><a href="front-end-development.php">Front-End Development</a> </h4>
          ...
          <div class="col-lg-4 col-md-6 mt30 wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
            <div class="service-card-app hoshd">
              <h4><a href="back-end-development.php"> Back-End Development</a></h4>
              <ul class="-service-list mt10">
...
<section class="case-study pad-tb bg-gradient6 deep-dark">
  <div class="container">
    ...
    <div class="service-footer">
      ...
      <div class="single-btn">
         <a href="#offcanvasExample" data-bs-toggle="offcanvas" class="btn-main bg-btn lnk wow fadeIn re-color" data-wow-delay="0.8s">Lets Work Together <i class="fas fa-chevron-right fa-ani"></i><span class="circle"></span></a>
      </div>
     </div>
  </div>
</section>
 ...
 <section class="work-category pad-tb">
  ...
  <!-- form -->
  <section class="enquire-form pad-tb" style="background: linear-gradient(#F0FDFD, #FFFFFF);">
    <div class="container">
      <div class="row light-bgs new">
        <div class="col-lg-6">
          <div class="common-heading text-l">
