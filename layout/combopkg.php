               ...
               <div class="col-lg-12 col-md-12">
                  <div class="combo-pricing-table best-plan">
                     <div class="niwaxpricingbox shadow reco selected-itm">
                        <div class="combo-pricingheader" data-background="assest/images/icons/new/3643948.svg" style="background-image: url(&quot;assest/images/icons/new/3643948.svg&quot;);">
                           <h2>Mega Discount <br>Combo Package</h2>
                           <p>Great For Small Business</p>
                        </div>
                        <div class="combo-pricingrate">
                           <div class="pricevalue">
                              <h2><sup>$ </sup>2,999 <del> $3,748</del> </h2>
                           </div>
                        </div>
                        ...
                        <div class="priceodernow">
                           <a href="#offcanvasExample" data-bs-toggle="offcanvas" data-sku="Mega Discount Combo Package ~ $2,999" class="pkg_btn btn-main bg-btn lnk wow fadeIn" data-wow-delay="0.2s">Let's Order Now <i class="fas fa-chevron-right fa-ani"></i><span class="circle"></span></a>
