      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="image-block upset">
            <img src="assest/images/cms1.webp" alt="case study" class="img-fluid no-shadow">
          </div>
        </div>
        <div class="col-lg-6 block-1 v-center">
          <div class="common-heading inner-heading text-l pl25">
            ...
            <h2>CMS Development Services to Increase Your Profits</h2>
            <p>
Your Our expert CMS developers will help you build a functional and feature-rich website. They will help you choose the right tools and customize your website to match your needs. We will set up your CMS so that it's easily accessible and compatible with different browsers. Our team of experts will help you add fresh content to your website regularly. Whether you want to post blogs, news articles, video or audio files, we can help you accomplish it effortlessly. We will also train you and your staff to use your new CMS, so that everyone knows how to manage your website efficiently.
              </p>
            <p>  
We know that managing a website takes time and effort. As such, our aim is to make this process as simple and convenient for you as possible. So if you want to save time and money while building a robust website, we can help you. We have designed and developed many CMS solutions for clients across the globe. We have helped several clients increase their conversion rates and boost their revenue. With our help, you can do the same.
            </p>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="image-block upset bg-shape wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
            <img src="assest/images/cms-development.webp" alt="image" class="img-fluid">
          </div>
        </div>
