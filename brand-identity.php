      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="image-block upset">
            <img src="assest/images/brand-identity.png" alt="case study" class="img-fluid no-shadow">
          </div>
        </div>
        <div class="col-lg-6 block-1 v-center">
          <div class="common-heading inner-heading text-l pl25">
            <span>We Offer Exceptional</span>
            <h2>Branding Services That Help You Stand Out</h2>
            <p>
            Whether you're starting up a new business or trying to revitalize an old brand, we can help. Our team is experienced in crafting logos, designing websites, and much more. No matter what kind of branding you need, we can deliver. 
            We can even offer guidance on marketing campaigns and social media strategies. We'll help you build a strong online presence and establish authority in your field. 
              </p>
            <p>  
            Our team is experienced in developing a wide variety of different types of brands. That includes product packaging, corporate identities, and more. We can also help you to create a brand voice and tone that matches your needs. 
            We can also help you build a recognizable identity and a loyal following. Our goal is to help you grow as quickly as possible. We believe that success is the result of hard work and dedication.
            </p>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="image-block upset bg-shape wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
            <img src="assest/images/branding-identity-2.png" alt="image" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-8 block-1">
          <div class="common-heading text-l pl25">
            ...
            <p>
                No matter what you need, we can deliver. We can even offer guidance on marketing campaigns and social media strategies. We'll help you build a strong online presence and establish authority in your field. 
                Our team consists of highly skilled graphic designers and experienced developers. That allows us to deliver high-quality results quickly and efficiently.
            </p>
          </div>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <div class="niwax-list">
        <ul class="list-ul ul-circle">
           <li> Be Consistent Across All Platforms</li>
           <li> Keep It Simple</li>
          <li>  Stay Current with Trends</li>
          <li>  Avoid Clichés</li>
          <li>  Use Brand Colors Everywhere</li>
          <li>  Make Sure Your Brand is Visible</li>
