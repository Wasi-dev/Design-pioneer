          ...
          <div class="col-lg-12 v-center">
            <div class="bread-inner">
              <div class="bread-title">
                <h2>Marketing/Promo Video Animation</h2>
                  <p class="mt20 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                    You know your product inside and out. And your customers should, too. It's time to tell them all about it with a promotional video. 
                    Animated marketing videos are an excellent way to connect with your customers and build trust, confidence and loyalty.
                  </p>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="image-block upset">
            <img src="assest/images/video.webp" alt="case study" class="img-fluid no-shadow">
          </div>
        </div>
        <div class="col-lg-6 block-1 v-center">
          <div class="common-heading inner-heading text-l pl25">
            <span>We Offer Exceptional</span>
            <h2>Video Animations That Help Grow Your Business</h2>
            <p>
            These days, it seems like there's something new happening online every minute of the day. In this digital age, businesses constantly struggle to stay ahead. 
            If you want to grow your business, then you need to find innovative ways to market yourself. A great place to start is with an engaging marketing video. Animated marketing videos are a fun and creative way to introduce potential customers to your brand. 
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="image-block upset bg-shape wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
            <img src="assest/images/video-1.webp" alt="image" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-8 block-1">
          <div class="common-heading text-l pl25">
            ...
            <p>
                ...
                Our talented team members can work closely with you to create a video that will engage your audience and encourage them to share it with others. With an engaging video, you'll be able to reach a much larger audience and boost sales significantly. 
                We can help you craft a message that resonates with your target audience and will work hard to make your vision a reality.
                </p>
          </div>
     ...
     <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="common-heading">
          ...
          <h2 class="mb30">With Us, You Have Complete Freedom to Create an Engaging Video from <span> Scratch.</span></h2>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <div class="niwax-list">
        <ul class="list-ul ul-circle">
           <li> Add audio to your videos to improve their overall quality</li>
           <li> Use high-resolution assest/images in your animated videos</li>
          <li>  Make sure that your video follows a logical structure</li>
          <li>  Not afraid to experiment when it comes to the length of your videos</li>
          <li>  Keep your animations as simple as possible</li>
