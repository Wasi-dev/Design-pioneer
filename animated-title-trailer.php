          ...
          <div class="col-lg-12 v-center">
            <div class="bread-inner">
              <div class="bread-title">
                <h2>Animated Title & Trailer</h2>
                  <p class="mt20 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
We offer title animation services for all types of movies, such as feature films, documentaries, shorts, comedies, horror flicks, dramas, etc. Our titles are designed using advanced 3D technologies and can be customized to suit your exact requirements. 
                  </p>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="image-block upset">
            <img src="assest/images/title-2.webp" alt="case study" class="img-fluid no-shadow">
          </div>
        </div>
        <div class="col-lg-6 block-1 v-center">
          <div class="common-heading inner-heading text-l pl25">
            ...
            <h2>Animated Titles & Trailers That Leave an Impact</h2>
            <p>
When it comes to providing outstanding animated titles and trailers, our team understands the importance of creating a strong first impression. Our talented animators will help your movie stand out and grab the attention of your audience. We have worked with many clients over the years, including some of the biggest names in Hollywood. No matter how big or small your production may be, we're happy to help you put together a high-quality trailer that leaves the right kind of impact.
              </p>
            <p>  
Our team members are committed to delivering only the best results possible. Regardless of whether you need a simple title animated or a full-length motion picture, we have the skills and expertise necessary to make your vision come to life. Our goal is to always exceed expectations while working closely with each client to ensure that they get exactly what they want. With our help, you'll be able to take your movie to the next level.
            </p>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="image-block upset bg-shape wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
            <img src="assest/images/title-1.webp" alt="image" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-8 block-1">
          <div class="common-heading text-l pl25">
            <span>Experts at Logo Octa Offer</span>
            <h2>Animated Titles & Trailers for the Biggest Names in Entertainment </h2>
            <p>
We have over 20 years of experience in the industry and understand perfectly well what it takes to create memorable and impressive animated titles and trailers. Our talented crew can assist you in every phase of the process, from helping you develop a script to designing the perfect artwork for the title sequence. We believe that the key to success is good communication, which is why we work closely with each and every one of our clients throughout the entire duration of the project.
                </p>
                <p>We specialize in both 2D and 3D animation, so you can rest assured that we'll be able to handle even the most complicated projects. If you'd like to learn more about our services, please don't hesitate to contact us today.</p>
          </div>
      ...
      <div class="col-lg-4">
        ...
        <ul class="list-ul ul-circle">
         ...
         <li> Add audio to your videos </li>
          <li>  Use high-resolution assest/images</li>
         <li>  Your video follows a logical structure</li>
         <li>   Not afraid to experiment</li>
         <li>   Keep your animations simple</li>
         <li>   Don't use too many colors or textures</li>
