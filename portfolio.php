   <?php include 'layout/header.php';?>
     ...
     <section class="breadcrumb-area banner-3" style="background-image:url('../assest/images/service/ecommerce/ecom-bg.png');">
          ...
          <div class="text-block">
            <div class="container">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 v-center">
                  <div class="bread-inner">
                    <div class="bread-title">
                      <h2>Creating Discerning Web Designs to Skyrocket Your Brand</h2>
					  <p>We can help you create a unique brand identity for your business. Our designers will work hard to create a design that represents your brand. They'll use their creativity to create something truly amazing.
					  We'll offer multiple concepts and ideas so that you can choose the one that suits your preferences.</p>
                    </div>
                  </div>
                </div>
              </div>
